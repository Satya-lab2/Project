    ...
    >
      <Link href="/" className="flex items-center gap-3 px-4 py-5 border-b border-blue-700/40">
        ...
        {!collapsed && (
          <div className="leading-tight overflow-hidden">
            ...
            <div className="text-xs text-blue-300 tracking-widest whitespace-nowrap">CARGO SYSTEM</div>
          </div>
        )}
      </Link>
      ...
      {!collapsed && (
        <div className="px-4 pt-5 pb-2">
          <span className="text-xs text-blue-400 font-semibold tracking-widest">ADMIN MENU</span>
        </div>
      )}
